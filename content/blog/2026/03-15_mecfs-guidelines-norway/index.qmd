...
summary: >
  ...
  response. Here's what the guidelines get wrong, why it matters, and how you can
  respond before the May 4th deadline.
---
...
```{r}
#| label: fig-eckey-treatments
#| echo: false
#| fig-cap: "Patient-reported treatment outcomes in ME/CFS and Long COVID. Pacing is rated most helpful; graded exercise therapy is rated most harmful. Data from Eckey et al. (2025), survey of 3,925 patients."
#| fig-alt: "A lollipop chart showing patient-reported treatment outcomes. Pacing scores +75.2, graded exercise therapy scores -72.2. CBT is near zero at +2.1."
#| fig-width: 8
#| fig-height: 5.5
...
```{r}
#| label: fig-wormgoor-pem-care
#| echo: false
#| fig-cap: "Health worsening after rehabilitation, by whether PEM was addressed in care. Data from Wormgoor & Rodenburg (2023)."
#| fig-alt: "A chart showing health worsening rates after rehabilitation. When PEM is not addressed, 54.5% worsen at one month. When PEM is addressed, 29% worsen."
#| fig-width: 9
#| fig-height: 5
...
```{r}
#| label: fig-coflow-pem
#| echo: false
#| fig-cap: "Post-exertional malaise predicts worse recovery at 3 years. Data from the CO-FLOW study (2025), prospective cohort of 292 patients."
#| fig-alt: "A chart showing recovery at 3 years. Patients with PEM report 55% recovery versus 88% without PEM."
#| fig-width: 8
#| fig-height: 3.5
