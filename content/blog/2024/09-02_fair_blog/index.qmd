...
#| echo: false
#| name: post-path
post <-  "content/blog/2018/04-05-gamm-random-effects/index.md"
post
post <- here::here(post)
```
...
1. an authenticating part
1. something we sent to the API (the body)
...
deposition <- list(
  created = "2024-08-19T17:25:45.834974+00:00", 
  modified = "2024-08-19T17:25:45.886678+00:00", 
  id = 13344546L, 
  conceptrecid = "13344545", 
  metadata = list(
    title = "GAMM random effects", 
    publication_date = "2018-04-05", 
    description = "I'm working a lot with Generalized Additive Mixed Models (GAMMs) lately, and so, it seems I will be doing a small series on them as we go now. After a little feedback, I did some small alterations to the last post, hopefully it is a little easier to follow, you can read it [here](blog/gamm-spaghetti-plots-in-r-with-ggplot/).", 
    access_right = "open", 
    creators = list(list(
      name = "Athanasia Monika Mowinckel", 
      affiliation = NULL,
      orcid = "0000-0002-5756-0223")), 
  keywords = list("R", "GAMM"), 
  language = "eng", 
  license = "cc-by-4.0", 
  ...
  publication_type = "other", 
  prereserve_doi = list(
    doi = "10.5281/zenodo.13344546", 
    recid = 13344546L)), 
  title = "GAMM random effects", 
  links = list(
    self = "https://zenodo.org/api/deposit/depositions/13344546", 
    html = "https://zenodo.org/deposit/13344546", 
    badge = "https://zenodo.org/badge/doi/.svg", 
    files = "https://zenodo.org/api/deposit/depositions/13344546/files", 
    bucket = "https://zenodo.org/api/files/42fcbc54-55cd-4579-a56d-37a42344a41e", 
    latest_draft = "https://zenodo.org/api/deposit/depositions/13344546", 
    latest_draft_html = "https://zenodo.org/deposit/13344546", 
    publish = "https://zenodo.org/api/deposit/depositions/13344546/actions/publish", 
    edit = "https://zenodo.org/api/deposit/depositions/13344546/actions/edit", 
    discard = "https://zenodo.org/api/deposit/depositions/13344546/actions/discard", 
    newversion = "https://zenodo.org/api/deposit/depositions/13344546/actions/newversion", 
    registerconceptdoi = "https://zenodo.org/api/deposit/depositions/13344546/actions/registerconceptdoi"), 
  record_id = 13344546L, 
  owner = 87533L, 
  files = list(), 
  state = "unsubmitted", 
...
pub_deposition <- list(metadata = list(doi = "10.5281/zenodo.13344546"))
```
