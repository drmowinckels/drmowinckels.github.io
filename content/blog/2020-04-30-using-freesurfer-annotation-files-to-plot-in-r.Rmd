...
dpv <- ggsegExtra::annot2dpv(annot_file, "~/Desktop/annot.dpv")
as_tibble(dpv)
```
...
![screenshot of ply file in Finder](blog/2020-04-30-using-freesurfer-annotation-files-to-plot-in-r_files/ply_ss.png)
